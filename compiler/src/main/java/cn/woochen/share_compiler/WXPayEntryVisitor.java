package cn.woochen.share_compiler;
...
public class WXPayEntryVisitor extends SimpleAnnotationValueVisitor7<Void,Void>{
    ...
    private void generateWXPayCode() {
        // 生成 一个 Class xxx.wxapi.WXEntryActivity extends BaseWXShareActivity
        TypeSpec.Builder classSpecBuilder = TypeSpec.classBuilder("WXEntryActivity")
